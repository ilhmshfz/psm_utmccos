...
import 'package:utmccos/Controller/ProfileController/bloc/authentication_bloc.dart';
...
class _AuthenticationScreenState extends State<AuthenticationScreen> {
  AuthenticationBloc? authenticationBloc; //initialize bloc state management for authentication
  StreamSubscription? subscription;

  //define all the required controllers to handle user inputs signup and signin forms
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                AutoSizeText(
                                  "Welcome back, fill in your registered account detail",
                          ...
                          Padding(
                            ...
                            child: CupertinoTheme(
                                ...
                                child: CupertinoButton.filled(
                                    ...
                                    onPressed: () async {
                                      //handle a login event. The event carries the user's entered credentials
                                      // for further processing by the Bloc
                                      authenticationBloc!.add(
                                          AuthenticatioLogin(
                                              userName: userNameController.text,
                                              password: passwordController.text,
                            ...
                            Padding(
                              ...
                              child: CupertinoTheme(
                                  ...
                                  child: CupertinoButton.filled(
                                      ...
                                      //when clicked, validates user input and triggers a signup event in the AuthenticationBloc
                                      // for further processing. The Bloc will likely handle user registration logic and 
