...
import 'package:utmccos/Controller/ProfileController/bloc/order_bloc.dart';
import 'package:utmccos/View/ProfileScreen/OrderScreen/order_detail_screen.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:get/get.dart';

//manage the order history state using bloc and getx. It displays the order list,
//handles empty states, and allows navigating to order details
                              ...
                              CupertinoButton(
                                ...
                                onPressed: () {
                                  Get.to(OrderDetailScreen(
                                    //show the detail list of product
...
//layout for display the order history
