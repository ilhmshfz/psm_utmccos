...
import 'package:utmccos/View/ProfileScreen/AuthenticationScreen/authentication_screen.dart';
import 'package:utmccos/View/ProfileScreen/FavoriteScreen/favorite_screen.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ProfileFunctions profileFunctions = profileController.profileFunctions;
        ...
        child: Column(
          children: [
            ...
            Obx(
              () => profileItem(
                callback: () {
                  final isLogin = profileController.authenticationFunctions.isUserLogin();
                  if (isLogin) {
                    showCupertinoDialog(
                      context: context,
                      builder: (context) {
                        return CupertinoAlertDialog(
                          title: Text(
                            "Log Out",
                            style: textStyle.titleLarge.copyWith(color: colors.red),
                          ),
                          content: Text(
                          ...
                          actions: [
                            ...
                            CupertinoButton(
                              child: Text(
                                "Yes",
                                style: textStyle.bodyNormal.copyWith(color: colors.red),
                              ),
                              onPressed: () async {
                                await profileController.authenticationFunctions.signOut();
                                Get.back();
                              },
                            ),
                          ],
  ...
  String signStatus({required ProfileController profileController}) {
    final bool isLogin = profileController.authenticationFunctions.isUserLogin();
    if (isLogin) {
      return "Log out";
    } else {
      return "Login";
