...
//displays the payment confirmation screen, interacts with the order processing logic, and handles successful payment actions
    ...
    return Scaffold(
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
            ...
            onPressed: () {
              //defines the action that happens when the user taps the "Pay" button in the PaymentScreen.
              showCupertinoDialog(
                context: context,
                builder: (context) {
                      ...
                      CupertinoButton(
                        ...
                        onPressed: () async {
                          await profileController.orderFunctions.addToOrderBox(
                            // add the order details to storage, clear the cart, 
                            //and then navigate to the home screen with a success message
