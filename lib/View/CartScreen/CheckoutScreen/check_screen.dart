...
import 'package:utmccos/Controller/CheckoutController/bloc/checkout_bloc.dart';
import 'package:utmccos/View/CartScreen/PaymentScreen/payment_screen.dart';
...
//manages the checkout screen UI, interacts with the checkout logic through a bloc, 
//and handles user interactions like selecting addresses and navigating to payment
          ...
          if (state is CheckoutGetAddreesScreen) {
            ...
            addAddressBottomSheet(
              ...
              dropDown: DropdownButtonFormField2(
                  buttonStyleData: ButtonStyleData(width: Get.size.width * 0.9),
                                          ...
                                          ? SizedBox(
                                              ...
                                              child: DropdownButtonFormField2(
                                                decoration: InputDecoration(
                                                    ...
                                                    hintStyle:
                                                        textStyle.bodySmall),
                                                dropdownStyleData: DropdownStyleData(maxHeight: Get.size.height * 0.6, decoration: dropDownDecoration()),
                                                isExpanded: true,
                                                items: addresList,
                                                onChanged: (value) {
                                                  addressDetail = value;
