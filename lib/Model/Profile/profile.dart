...
//handles user profile storage/retrieval using Hive for local data and GetX for state management.
class ProfileFunctions {
  ...
  Future<bool> addToDonation({required ProductEntity productEntity}) async {
  ...
  Future<bool> removeDonation({required ProductEntity productEntity}) async {
    final box = Hive.box<ProductEntity>(favoriteBox);
